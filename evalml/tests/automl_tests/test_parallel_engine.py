...
def test_evaluate_batch_sequential(mock_fit, mock_score, dummy_parallel_binary_pipeline_class, X_y_binary):
    X, y = X_y_binary
    ...
    def mock_score2():
        return [{'Log Loss Binary': 0.42}] * 3 + [{'Log Loss Binary': 0.5}] * 3
    for pipeline in pipelines:
        pipeline.score = mock_score2
